...
const RecurrenceEntitySchema = Schema(
  name: r'RecurrenceEntity',
  id: -2551501680102158894,
  properties: {
  ...
  estimateSize: _recurrenceEntityEstimateSize,
  serialize: _recurrenceEntitySerialize,
  deserialize: _recurrenceEntityDeserialize,
  deserializeProp: _recurrenceEntityDeserializeProp,
);

int _recurrenceEntityEstimateSize(
  RecurrenceEntity object,
  List<int> offsets,
...
void _recurrenceEntitySerialize(
  RecurrenceEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
RecurrenceEntity _recurrenceEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = RecurrenceEntity();
...
P _recurrenceEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
extension RecurrenceEntityQueryFilter
    on QueryBuilder<RecurrenceEntity, RecurrenceEntity, QFilterCondition> {
  QueryBuilder<RecurrenceEntity, RecurrenceEntity, QAfterFilterCondition>
...
extension RecurrenceEntityQueryObject
    on QueryBuilder<RecurrenceEntity, RecurrenceEntity, QFilterCondition> {}
